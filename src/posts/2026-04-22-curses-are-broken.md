...
ogImage: "https://storage.googleapis.com/ionrift-media/og/curses-part1.png"
---

The first cursed item I dropped into a session was the Berserker Axe. SRD, straight out of the book. Thought it'd be fun.

<figure>
  <img src="{{ site.mediaBaseUrl }}/blog/2026/curses-part1/berserker-axe.png" alt="Berserker Axe item sheet in Foundry, unidentified and after Identify" width="960" loading="lazy" decoding="async" />
  <figcaption>Top: unidentified. Bottom: after Identify, curse text included.</figcaption>
</figure>
...
<figure>
  <img src="{{ site.mediaBaseUrl }}/blog/2026/curses-part1/javelin-unidentified.png" alt="Javelin of Lightning sheet in Foundry while still marked unidentified" width="960" loading="lazy" decoding="async" />
  <figcaption>Name hidden, attack and damage still on the sheet.</figcaption>
</figure>
...
<figure>
  <img src="{{ site.mediaBaseUrl }}/blog/2026/curses-part1/longsword-compare.png" alt="Mundane longsword next to masked +1 longsword in Foundry" width="960" loading="lazy" decoding="async" />
  <figcaption>Even masked, a magic item's sheet can diverge from a mundane one.</figcaption>
</figure>
